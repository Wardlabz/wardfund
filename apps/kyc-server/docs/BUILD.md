...
This document explains the build process for the WardFund KYC Server application, which uses Bun's built-in bundler to compile the client-side JavaScript.
