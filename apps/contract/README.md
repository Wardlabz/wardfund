# WardFund Smart Contracts

A collection of Rust-based Soroban smart contracts deployed on the Stellar blockchain, powering the WardFund platform's authentication, NFT issuance, academy system, and reputation management.
...
2. **NFT Contracts** - Token issuance for WardFund platform and academy graduation certificates
...
#### WardFund NFT (`nft-wardfund`)

- Standard NFT contract for WardFund platform tokens
...
Deploy the WardFund NFT contract using the deployment script:
...
- `--name NAME`: NFT collection name (default: "WardFund Kinder NFT")
...
Deploy the WardFund Reputation contract:
