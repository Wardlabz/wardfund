# WardFund Reputation Contract

A reputation contract for the WardFund ecosystem that tracks user points, calculates levels, and integrates with the NFT contract for automatic metadata updates. Built on OpenZeppelin Stellar Contracts v0.6.0 for Soroban.
...
The Reputation contract can integrate with the WardFund NFT contract to automatically update NFT metadata when a user levels up.
