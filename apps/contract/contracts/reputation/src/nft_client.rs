//! NFT Client module for cross-contract calls to the WardFund NFT contract.
//!
...
// ============================================================================
// NFT Metadata Types (mirrors nft-wardfund types, SEP-0050 compliant)
// ============================================================================

/// NFT attribute following SEP-0050 JSON schema.
/// Must match the nft-wardfund NFTAttribute structure exactly.
#[contracttype]
...
/// NFT Metadata structure matching the nft-wardfund contract.
