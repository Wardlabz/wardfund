...
///
/// A non-fungible token contract for the WardFund platform's reputation and
...
#[contractimpl]
impl WardFundNFT {
    /// Initialize the WardFund NFT contract.
    ///
    /// # Arguments
...
impl NonFungibleToken for WardFundNFT {
    ...
    fn transfer(e: &Env, from: Address, to: Address, token_id: u32) {
        ...
        WardFundNFT::extend_instance_ttl(e);
    }
...
#[contractimpl]
impl NonFungibleBurnable for WardFundNFT {
