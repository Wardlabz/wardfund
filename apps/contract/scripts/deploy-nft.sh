#!/bin/bash
# deploy-nft.sh
# Deployment script for WardFund NFT Contract
...
SOURCE=""
ADMIN_ADDRESS=""
NFT_NAME="WardFund Kinder NFT"
NFT_SYMBOL="KINDER"
BASE_URI="https://api.wardfund.org/nft/"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo "  --name NAME        NFT collection name (default: 'WardFund Kinder NFT')"
...
=== WardFund NFT Contract Deployment ===
Network:         $NETWORK
