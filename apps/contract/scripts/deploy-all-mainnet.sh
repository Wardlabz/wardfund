...
# Orchestrates full WardFund contract deployment to Stellar mainnet.
...
Deploy all WardFund Soroban contracts to mainnet in dependency order.
...
echo "========================================"
echo "  WardFund Mainnet Full Deployment"
echo "========================================"
...
if [[ "$SKIP_CONFIRM" != "true" ]]; then
    echo "This will deploy ALL WardFund contracts to MAINNET using real XLM."
...
# WardFund Mainnet — generated $(date -u +"%Y-%m-%dT%H:%M:%SZ")
