	...
	return (
		...
		>
			<Text className="text-2xl font-bold text-center text-gray-900 mb-4">
				WardFund: One Wallet. One Blockchain. One World. Real Change.
			</Text>

			<Text className="text-gray-700 mb-4 leading-6">
				At WardFund, we're building more than a platform — we're building a
				movement. Powered by the Stellar blockchain, WardFund turns a single
			...
			<View className="flex-row flex-wrap justify-center space-y-4 md:space-y-0 md:space-x-4">
				...
				>
					<Pressable
						onPress={onDiscoverPress || (() => console.log('Tapped Discover more about WardFund'))}
						className="border border-green-600 py-3 px-6 rounded-full items-center"
						accessibilityLabel="Discover more about WardFund"
						accessibilityRole="button"
					>
						<Text className="text-green-600 font-semibold text-center">
							Discover more about WardFund
						</Text>
					</Pressable>
				</MotiView>
			</View>
