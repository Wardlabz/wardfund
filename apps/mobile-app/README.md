# WardFund Mobile App (Expo + NativeWind + Gluestack UI)

Welcome to the WardFund mobile app — a companion experience to the WardFund Web3 crowdfunding platform. This mobile app allows users to explore social impact campaigns, contribute securely, track campaign milestones, and launch new projects from anywhere.
...
- [WardFund GitHub](https://github.com/wardfund)  
- [OnlyDust](https://app.onlydust.com/) for open issues and bounties  
- [WardFund Discord](https://discord.gg/wardfund) (Coming soon)
