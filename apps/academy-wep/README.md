...
Welcome to **WardFund Academy**—the onboarding platform for project owners and foundations raising funds through WardFund. The academy provides essential training on blockchain basics, Stellar network fundamentals, and the management of USDC and XLM. Completion of the WardFund Academy learning path is required to unlock the **first tranch** of funding for your project.
...
> Update the `.env` file with the appropriate development credentials provided by the WardFund team.
...
WardFund Academy provides structured lessons on the following topics:
...
3. **USDC and XLM** – How to use USDC and XLM within the WardFund ecosystem.

✅ Upon completion of the academy, participants will receive a **graduate NFT** as proof of completion.  
✅ This NFT will unlock the first tranch of project funding within the WardFund escrow system.
...
We welcome contributions from the WardFund community!  
