      ...
      <SidebarContent className="bg-card">
        ...
        <SidebarGroup className="pb-4 border-b">
          <div className="flex items-center">
            <Image
              src="/images/wardfund-org.png"
              alt="WardFund Academy Logo"
              width={120}
              height={40}
              ...
              <SidebarGroup className="-mx-2">
                <SidebarGroupLabel asChild>
                  ...
                  >
                    ...
                    <span className="flex-1 text-left text-sm text-foreground">{path.name}</span>
                  ...
                  <SidebarGroupContent>
                    <SidebarMenu>
                      <SidebarMenuItem>
                        <SidebarMenuButton
                          asChild
                          className={cn("hover:bg-green-100 hover:text-primary", isActive(path.href, true) && "bg-green-100 text-primary")}
                        >
                          <Link href={path.href}>
                            <span>Overview</span>
                          </Link>
                      ...
                      {path.subItems.map((subItem) => (
                        <SidebarMenuItem key={subItem.name}>
                          <SidebarMenuButton
                            asChild
                            className={cn("hover:bg-green-100 hover:text-primary", isActive(subItem.href) && "bg-green-100 text-primary")}
                          >
        ...
        <div className="mt-auto p-4 text-xs font-normal text-gray-500 border-t">
          <p className="mb-2">© {new Date().getFullYear()} WardFund Academy</p>
