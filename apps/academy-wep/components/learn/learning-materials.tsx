...
export function LearningMaterials() {
  ...
  const modules: Module[] = [
    ...
    },
    {
      ...
      description: "Understand the Stellar network, consensus mechanism, and ecosystem.",
      lessons: 4,
      completed: 2,
      unlocked: true,
      category: "Stellar",
    ...
    },
    {
      ...
      description: "Set up and manage Stellar wallets securely for your project funds.",
      lessons: 6,
      completed: 0,
      unlocked: true,
      category: "Stellar",
    ...
    },
    {
      ...
      description: "Learn how to handle different assets on the Stellar network.",
      lessons: 5,
      completed: 0,
      unlocked: false,
      category: "Stellar",
    ...
    {
      id: 6,
      title: "WardFund Fund Management",
      description: "Best practices for managing crowdfunded resources on WardFund.",
      lessons: 3,
      completed: 0,
      unlocked: false,
      category: "WardFund",
  ...
  const resources: Resource[] = [
    {
      ...
      description: "A comprehensive guide to blockchain fundamentals and how they apply to social impact projects.",
      type: "article",
      category: "Blockchain",
      level: "Beginner",
      duration: "15 min read",
    ...
    },
    {
      ...
      description: "Step-by-step video tutorial on creating and securing your Stellar wallet for donations.",
      type: "video",
      category: "Stellar",
      level: "Beginner",
    ...
    },
    {
      ...
      description: "Learn the most effective strategies for running successful Web3 crowdfunding campaigns.",
      type: "guide",
      category: "Web3",
      level: "Intermediate",
      duration: "20 min read",
    ...
    },
    {
      ...
      description: "A detailed guide on handling different assets on the Stellar network for your projects.",
      type: "guide",
      category: "Stellar",
      level: "Intermediate",
      duration: "25 min read",
    ...
    },
    {
      ...
      description: "How blockchain technology ensures complete transparency in the donation process.",
      type: "article",
      category: "Blockchain",
      level: "Beginner",
      duration: "10 min read",
    ...
    {
      id: 6,
      title: "WardFund Platform Tutorial",
      description: "Complete walkthrough of the WardFund platform features and how to use them effectively.",
      type: "video",
      category: "WardFund",
      level: "Beginner",
      ...
      likes: 215,
      comments: 53,
      image: "/images/wardfund-org.png?height=240&width=400",
      tags: ["WardFund", "Tutorial", "Platform"],
    },
  ]
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
              <div>
                ...
                <p className="text-gray-600 max-w-2xl">
                  Browse through our collection of learning modules and resources to continue your blockchain education
                  journey.
                </p>
              </div>
            </div>
