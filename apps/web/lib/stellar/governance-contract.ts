 ...
 *
 * Calls the WardFund Governance Soroban contract using the backend service account.
 * The service account (SOROBAN_PRIVATE_KEY / wardfund-backend) holds both the
