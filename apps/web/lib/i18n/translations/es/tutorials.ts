export const tutorials = {
	...
	subtitle:
		'Guías paso a paso para ayudarte a sacar el máximo provecho de WardFund — desde crear tu cuenta hasta gestionar campañas y entender cómo se liberan los fondos.',
	sections: {
	...
	sectionDescriptions: {
		...
		campaigns:
			'Todo lo que necesitas para lanzar, gestionar y completar campañas basadas en hitos en WardFund.',
		donations:
	...
	cards: {
		register: {
			...
			description: 'Configura tu cuenta en WardFund y prepárate para apoyar o lanzar campañas.',
			steps: [
				'Ve a wardfund.org y haz clic en Registrarse.',
		...
		milestones: {
			...
			steps: [
				...
				'El equipo de WardFund o los validadores de la comunidad verificarán tu envío.',
		...
		createFoundation: {
			...
			steps: [
				...
				'Envía para verificación — el equipo de WardFund revisará tu solicitud.',
