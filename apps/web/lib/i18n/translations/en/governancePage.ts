export const governancePage = {
	...
	step1Description: 'Support causes and grow your Kinders NFT to unlock governance weight.',
	step2Title: 'Vote with heart',
	step2Description: 'Choose where the community fund should flow during active rounds.',
	step3Title: 'Fund moves on-chain',
	step3Description: 'Winning causes receive allocation through verified Trustless Work escrow.',
	tabActive: 'Active rounds',
	tabPast: 'Past rounds',
	roundsSectionTitle: 'Governance rounds',
	roundsEyebrow: 'Community votes',
	roundsSectionDescription: 'Review open votes or explore how past communities chose to give.',
	...
	emptyPastDescription: 'When rounds close, results and fund allocations will be recorded here.',
	...
	eligibilitySignInDescription: 'Connect your account to see if your Kinders NFT can vote.',
	...
	eligibilityReadyDescription: 'Your Kinders NFT gives you a weighted voice in every active round.',
