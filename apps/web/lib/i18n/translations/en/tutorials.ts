export const tutorials = {
	...
	subtitle:
		'Step-by-step guides to help you get the most out of WardFund — from creating your account to managing campaigns and understanding how funds are released.',
	sections: {
	...
	sectionDescriptions: {
		...
		campaigns:
			'Everything you need to launch, manage, and complete milestone-based campaigns on WardFund.',
		donations:
	...
	cards: {
		register: {
			...
			description: 'Set up your WardFund account and get ready to support or launch campaigns.',
			steps: [
				'Go to wardfund.org and click Sign Up.',
		...
		milestones: {
			...
			steps: [
				...
				'The WardFund team or community validators will verify your submission.',
		...
		createFoundation: {
			...
			steps: [
				...
				'Submit for verification — the WardFund team reviews your application.',
