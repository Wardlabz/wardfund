...
import { wardfundPollarProvider } from '~/auth/wardfund-pollar.provider'
...
export const nextAuthOption: NextAuthOptions = {
	adapter: WardFundSupabaseAdapter(),
	providers: [wardfundWebAuthnProvider, wardfundPollarProvider],
	pages: {
		signIn: '/sign-in',
		// signOut: '/sign-out',
	},
