...
export const LEGAL_DOCS: Record<LegalDocId, LegalDocConfig> = {
	terms: {
		...
		title: 'Terms of Use',
		description:
			'Terms governing your use of WardFund, including accounts, donations, escrow, governance, and platform responsibilities.',
	...
	privacy: {
		...
		description:
			'How WardFund collects, uses, and protects personal information, wallet data, and KYC verification status.',
	...
	cookies: {
		...
		title: 'Cookie Policy',
		description:
			'How WardFund uses cookies for authentication, security, language preferences, and analytics.',
	...
	licenses: {
		...
		title: 'Licenses',
		description:
			'Open-source licensing for WardFund software, brand asset restrictions, and third-party license notices.',
