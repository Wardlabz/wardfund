...
export function getProjectShareDescription(title: string, description: string | null): string {
	...
	return `Support ${title} on WardFund — transparent Web3 crowdfunding for social impact on the Stellar blockchain.`
}
			...
			images: [
				{
					...
					width: 1200,
					height: 630,
					alt: `${project.title} — WardFund crowdfunding campaign`,
				},
			],
		},
		twitter: {
