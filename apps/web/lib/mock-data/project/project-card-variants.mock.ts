...
export const faqData: Record<string, FAQ[]> = {
	platform: [
		{
			id: '1',
			question: 'What is WardFund, and how does it work?',
			answer:
				'WardFund is a Web3 crowdfunding platform for social impact causes. It uses blockchain and AI to ensure secure, transparent donations through milestone-based fund releases. Supporters can discover campaigns, donate using crypto, and track how funds are used.',
			category: 'platform',
		},
		{
			id: '2',
			question: 'How does WardFund ensure transparency and trust?',
			answer:
				'WardFund integrates the Stellar blockchain and trustless escrow to record every donation on-chain. Funds are only released when project milestones are verified, ensuring total transparency and accountability.',
			category: 'platform',
		},
		{
			id: '3',
			question: 'What makes WardFund different from traditional crowdfunding platforms?',
			answer:
				'WardFund eliminates intermediaries, reduces fees, and introduces blockchain-powered accountability. It offers gamified rewards, open-source development, and AI-driven campaign optimization—all with a focus on social good.',
			category: 'platform',
		},
		{
			id: '4',
			question: 'Is WardFund open source? Can I contribute?',
			answer:
				'Yes! WardFund is an open-source project welcoming developers at all levels. You can contribute via structured GitHub issues, OnlyDust hackathons, and join our growing contributor community.',
			category: 'platform',
		},
		{
			id: '5',
			question: 'Which blockchain does WardFund use, and why Stellar?',
			answer:
				'WardFund is powered by the Stellar blockchain for its low fees, fast transactions, and global accessibility. Stellar also supports our milestone-based escrow model to guarantee transparency.',
			category: 'platform',
		},
		{
			id: '6',
	...
	campaigns: [
		{
			id: '7',
			question: 'How do I start a fundraising campaign on WardFund?',
			answer:
		...
		},
		{
			...
			answer:
				'You need a verified identity (KYC), a well-defined cause, and milestone plans. Completion of the WardFund Academy onboarding ensures your project meets our transparency and impact criteria.',
			category: 'campaigns',
		},
		{
			id: '9',
		...
		},
		{
			...
			answer:
				'WardFund charges minimal fees to sustain the platform, but they are significantly lower than traditional crowdfunding platforms thanks to blockchain efficiencies.',
			category: 'campaigns',
		},
		{
			id: '13',
			question: 'How does WardFund verify and approve campaigns?',
			answer:
				'WardFund uses AI to review campaigns for legitimacy and clarity. Human moderation ensures alignment with social impact standards. Only verified projects are listed.',
			category: 'campaigns',
		},
		{
			id: '14',
	...
	donors: [
		{
			id: '15',
			question: 'How do I donate to a campaign on WardFund?',
			answer:
		...
		{
			id: '16',
			question: 'Which cryptocurrencies does WardFund accept?',
			answer:
				'WardFund currently supports donations in USDC and XLM, with plans to expand to additional Stellar-compatible and ERC-20 tokens.',
			category: 'donors',
		},
		{
			id: '17',
			question: 'Why does WardFund use USDC and XLM for donations?',
			answer:
		...
		{
			id: '19',
			question: 'How do I connect my wallet to WardFund?',
			answer:
		...
		},
		{
			...
			answer:
				'Yes, but they are minimal thanks to Stellar’s low-cost blockchain. WardFund does not charge additional fees on top of blockchain gas fees.',
			category: 'donors',
		},
		{
			id: '21',
		...
		},
		{
			...
			answer:
				'Each transaction is recorded on-chain. You can view your donation history in your WardFund profile or verify it directly on the Stellar explorer.',
			category: 'donors',
		},
		{
			id: '23',
	...
	security: [
		...
		{
			id: '25',
			question: 'How does WardFund ensure funds go to the right projects?',
			answer:
