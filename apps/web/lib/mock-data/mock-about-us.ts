export const mockAboutUs = {
	...
	whyIsDifferent: [
		...
		},
		{
			...
			description:
				'Anyone can contribute — no matter the currency, language, or location. WardFund supports multilingual access, crypto and fiat flows, and onramps for global inclusion.',
			icon: 'globe',
		},
	],
	wardfundStellarFeatures: [
		{
