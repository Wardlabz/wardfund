export const mockAboutUs = {
	hero: {
		...
		subheading:
			'WardFund is a Web3 crowdfunding platform using Stellar blockchain and AI to ensure transparency, trust, and efficiency in funding social impact projects.',
		ctas: [
