...
export const buildMatchingPrompt = (
	...
	return `Recommend 3 to 5 projects from the candidate list that best match this WardFund user.
...
export const MATCHING_SYSTEM_PROMPT = `You are WardFund's project matching engine. You help donors discover social-impact crowdfunding campaigns aligned with their values, donation patterns, and regional interests.
