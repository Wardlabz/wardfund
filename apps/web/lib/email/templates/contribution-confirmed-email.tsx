				...
				<Body className="bg-gray-50 text-gray-900">
					<Container className="mx-auto my-8 w-full max-w-[560px]">
						<Section className="bg-white rounded-2xl p-8 shadow">
							<Text className="text-2xl font-semibold mb-1">💙 Thank you for your support</Text>
							...
							<Text className="text-base leading-6 mb-3">
								Your contribution of <strong>{amount}</strong> to <strong>{projectTitle}</strong>{' '}
								has been confirmed. You are making a real difference!
							</Text>

							<Text className="text-base leading-6 mb-4">
								You will receive updates as the project reaches milestones and achieves its goals.
							...
							<Text className="text-sm text-gray-500">
								You are receiving this because you made a contribution on WardFund. If you did not
								expect this email, please contact WardFund support.
							</Text>
						</Section>
					</Container>
				</Body>
