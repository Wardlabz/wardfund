...
export function NewProjectEmail({
	...
	return (
		<Html lang="en">
			...
			<Preview>
				{isCreator
					? `Your project "${projectTitle}" is live on WardFund`
					: `New project "${projectTitle}" needs your support on WardFund`}
			</Preview>
			<Tailwind>
						...
						<Section className="bg-white rounded-2xl p-8 shadow">
							...
							{isCreator ? (
								...
								<>
									...
									<Text className="text-base leading-6 mb-4">
										Be one of the first to discover and support this project on WardFund.
									</Text>
								</>
							)}
