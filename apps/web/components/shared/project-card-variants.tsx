...
// Move components outside render to avoid React Compiler errors
const UserAvatar = () => (
	<svg
		viewBox="0 0 24 24"
		fill="none"
...
const ProjectView: React.FC<ProjectViewProps> = ({ onShowImpact }) => (
	<div className="mb-6">
		...
		<div className="space-y-4">
			...
			<div className="flex items-center gap-2 mt-6">
				...
				<div>
					...
					<div className="text-gray-500">This project has been verified by WardFund</div>
				</div>
			</div>
		</div>
	</div>
			...
			<div>
				...
				<div className="space-y-3">
					...
					<div className="p-4 bg-gray-50 rounded-lg">
						<div className="flex justify-between items-center">
							<h3 className="font-semibold text-gray-700">Impact Maker NFT</h3>
...
interface SuccessViewProps {
	renderAvatars: (count: number, prefix: string) => React.ReactNode
}

const SuccessView: React.FC<SuccessViewProps> = ({ renderAvatars }) => (
	<div className="space-y-4">
		<div className="max-w-md p-6 bg-white rounded-lg shadow">
			...
			<div className="bg-green-50 p-4 rounded-lg mb-4">
				<div className="flex items-center gap-2 mb-2">
					...
					<span className="text-gray-700 font-semibold">Top 10% Supporter</span>
				</div>
...
const ProjectCard: React.FC<ProjectCardProps> = () => {
	...
	// Main render logic
	if (showSuccess) {
		return <SuccessView renderAvatars={renderAvatars} />
	}
