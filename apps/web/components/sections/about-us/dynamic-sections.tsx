...
export const DynamicAboutSections = {
	...
	WardFundStellar: dynamic(() => import('./wardfund-stellar').then((mod) => mod.WardFundStellar), {
		loading: sectionLoading,
	}),
	HowItWorks: dynamic(() => import('./how-it-works').then((mod) => mod.HowItWorks), {
		loading: sectionLoading,
	}),
	WhyWardFundIsDifferent: dynamic(
		() => import('./why-is-different').then((mod) => mod.WhyWardFundIsDifferent),
		{ loading: sectionLoading },
	),
