...
export function AdminGamificationTriggers() {
	...
	const [nftName, setNftName] = useState('WardFund Impact NFT (Admin Test)')
								...
								onClick={() => {
									...
									handleSubmit({
										...
										metadata: {
											...
											imageUri: 'https://wardfund.org/images/nft-placeholder.png',
											externalUrl: 'https://wardfund.org/profile?section=gamification',
											attributes: [
