	...
	const onSubmit = async (data: FormValues) => {
		...
		try {
			...
			if (
				...
				userFriendlyMessage =
					'Your wallet and WardFund are on different Stellar networks. In Freighter, open Settings → Network, select Main Net, disconnect and reconnect your wallet here, then try again.'
