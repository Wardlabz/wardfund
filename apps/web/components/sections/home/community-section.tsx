...
const CommunitySection = () => {
	...
	const testimonialData = {
		quote:
			"The WardFund community becomes an ambassador for your social cause, taking your impact far beyond what traditional Web2 methods can achieve. Web3 connects and empowers people worldwide, creating a transparent, global, and secure network of support and verification powered by blockchain technology and Trustless work's Escrows. Supporting meaningful causes isn’t something you can buy—it’s a reward you earn by being part of a movement dedicated to real change.",
		author: 'WardFund',
			...
			<div className="container mx-auto px-4">
				...
				>
					...
					<p className="text-lg font-medium text-gray-600 leading-relaxed text-justify">
						WardFund is about building a thriving community that drives real
