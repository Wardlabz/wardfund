...
import { WardFundMission } from '~/components/sections/home/mision'
		...
		<section className="relative py-24 overflow-hidden">
			...
			<div className="relative container mx-auto px-4">
				...
				<motion.div {...fadeInUpAnimation}>
					<SectionCaption
						title="Join the WardFund Movement: Support Change. Earn Trust. Build Impact."
						subtitle="WardFund is more than a platform — it's a new way to fund real change. Whether you're a cause creator or a supporter, every action you take earns trust, builds your on-chain reputation, and strengthens a transparent, community-led ecosystem."
						highlightWords={[
