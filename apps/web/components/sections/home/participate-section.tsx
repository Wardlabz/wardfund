	...
	return (
		<section className="relative py-24 overflow-hidden">
			...
			<div className="relative container mx-auto px-4">
				...
				>
					<SectionCaption
						title="Join the WardFund Revolution: Collaborate and Transform the World with Web3"
						...
						highlightWords={['Transform the World with Web3', 'WardFund']}
					/>
				</motion.div>
				...
				>
					...
					<div className="relative">
						<h4 className="text-xl font-semibold text-center text-gray-900 mb-4">
							WardFund: One Better World
						</h4>
						<p className="text-gray-600 mb-8 leading-relaxed">
							At WardFund, you’re part of a movement demonstrating that Web3 is
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							...
							<Button
								size="lg"
								variant="outline"
								aria-label="Learn More About WardFund Platform"
