		...
		<section className="w-full px-4 py-20 sm:px-6 lg:px-8">
			<div className="mx-auto max-w-7xl">
				<SectionCaption
					...
					subtitle="At WardFund, every donation is secure, transparent, and verifiable. With Stellar-powered smart contracts and milestone-based fund releases, your crypto fuels real-world impact not empty promises."
