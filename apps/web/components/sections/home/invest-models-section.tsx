...
export const InvestmentModelsSection = () => {
	const models = [
		...
		},
		{
			...
			benefits: ['Impact Reports', 'Real-Time Tracking', 'Engaged Communities'],
		},
		{
		...
		<section className="w-full px-4 py-20 sm:px-6 lg:px-8">
			<div className="mx-auto max-w-7xl">
				<SectionCaption
					...
					subtitle="At WardFund, we ensure that every donation or contribution is backed by the security and transparency of a Web3-based Escrow system. Smart contracts guarantee that funds reach their intended destination to create real impact."
