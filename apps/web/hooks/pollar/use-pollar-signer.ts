...
import { useWardFundPollarClientState } from '~/lib/pollar/use-wardfund-pollar-client-state'
...
export const usePollarSigner = () => {
	...
	const { isAuthenticated, verified, wallet, getClient } = useWardFundPollarClientState()
