...
export const alt = 'WardFund project crowdfunding campaign'
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
	...
	const title = project?.title ?? 'WardFund Project'
	...
	return new ImageResponse(
		...
		>
			...
			<div style={{ fontSize: 24, opacity: 0.8 }}>wardfund.org/projects/{slug}</div>
		</div>,
		{
			...size,
		},
