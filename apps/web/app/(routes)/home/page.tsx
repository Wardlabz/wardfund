...
export const metadata: Metadata = {
	title: 'WardFund — Web3 Crowdfunding for Social Impact',
	description:
		'WardFund is the first blockchain-powered crowdfunding platform connecting donors with impactful social and environmental causes. Milestone-based funding on Stellar ensures transparency and accountability.',
	keywords: [
		'crypto crowdfunding',
		'social impact',
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: 'WardFund — Web3 Crowdfunding for Social Impact',
			},
		],
	},
	twitter: {
