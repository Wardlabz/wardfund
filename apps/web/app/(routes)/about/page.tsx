...
export const metadata: Metadata = {
	...
	description:
		"Learn about WardFund's mission, how milestone-based crowdfunding on Stellar works, and why transparent, blockchain-powered funding is the future of social impact.",
	openGraph: {
		title: 'About WardFund — Blockchain Crowdfunding for Social Impact',
		description:
	...
	twitter: {
		...
		title: 'About WardFund | Web3 Crowdfunding for Social Impact',
		description:
