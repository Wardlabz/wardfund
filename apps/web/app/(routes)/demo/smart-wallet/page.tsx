...
const SmartWalletTransferDemo = dynamic(
  () =>
    import("~/components/shared/smart-wallet-transfer-demo").then((mod) => ({
      default: mod.SmartWalletTransferDemo,
    })),
  {
    loading: () => (
...
export const metadata = {
  title: "Smart Wallet Demo | WardFund",
