...
export const metadata: Metadata = {
	title: 'Foundations | WardFund',
	description:
		'Discover nonprofit and community foundations on WardFund—missions, campaigns, and transparent impact on the Stellar blockchain.',
	openGraph: {
		title: 'Foundations | WardFund',
		description:
			'Explore verified organizations running campaigns on WardFund. Follow their work and support causes that match your values.',
		type: 'website',
		url: '/foundations',
	},
	twitter: {
		...
		title: 'Foundations | WardFund',
		description: 'Discover verified foundations and their impact campaigns on WardFund.',
	},
	alternates: {
