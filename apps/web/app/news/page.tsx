...
export const metadata: Metadata = {
	title: 'News | WardFund',
	description:
		'Latest WardFund news, product updates, and stories on transparent crowdfunding, blockchain, and social impact.',
}
			...
			<SectionContainer maxWidth="7xl">
				<header className="mb-10 sm:mb-14">
					...
					<p className="mt-2 text-muted-foreground max-w-xl">
						Product updates, impact stories, and insights from WardFund.
					</p>
				</header>
