...
export const metadata: Metadata = {
	title: 'News | WardFund',
	description:
		'Product updates, impact stories, and milestones from WardFund—transparent crowdfunding on Stellar.',
}
				...
				<header className="mb-10 flex flex-col gap-6 border-b border-border pb-10 sm:mb-12 sm:flex-row sm:items-end sm:justify-between sm:pb-12">
					<div className="min-w-0">
						...
						<p className="mt-3 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
							Product updates, field notes, and milestones from the WardFund team—same transparency
				...
				{rest.length > 0 ? (
					<section aria-labelledby="news-all-heading">
						...
						<p className="mt-1 text-sm text-muted-foreground sm:text-base">
							{rest.length} more {rest.length === 1 ? 'story' : 'stories'} on WardFund and our
							ecosystem.
						</p>
