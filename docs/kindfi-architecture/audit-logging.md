...
Structured audit logging for all mutation operations in the WardFund escrow and NFT subsystems. Logs are emitted as structured JSON to `console.info` and persisted to the `audit_logs` Supabase table.
