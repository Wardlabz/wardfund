...
# WardFund Development Philosophy

### Core Philosophy

WardFund builds blockchain technology for social impact, creating a transparent, community-driven crowdfunding platform. We combine AI-driven development with Web3 innovations to transform how meaningful causes connect with supporters.
...
- Leverage Next.js 15 App Router for optimal server-side rendering and React Server Components.
- Use Supabase for backend services, authentication, and real-time data.
- Implement DrizzleORM for type-safe database queries and migrations.
- Style with Tailwind CSS using utility-first principles.
- Build UI components with Radix UI and Shadcn UI for accessibility and consistency.
- Integrate Vercel AI SDK for AI-powered features.
- Develop smart contracts on Stellar/Soroban using Rust and OpenZeppelin Stellar Contracts.
- Follow AHA (Avoid Hasty Abstractions) programming principles to avoid premature abstractions.
