...
NEXTAUTH_URL=https://wardfund.org
...
```
https://wardfund.org/profile?kyc=completed
```
...
```
https://wardfund.org/api/kyc/didit/webhook
```

**Important**: Ensure both URLs use your production domain (`wardfund.org`) in production.
