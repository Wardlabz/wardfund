# WardFund Integration & Usage Guide
...
The WardFund web application, located in the apps/web directory, utilizes React for building user interfaces. To illustrate basic usage of UI components, consider the following example of a button component:
...
For state management, WardFund uses React Context and server actions in Next.js 15. Here's an example:
...
For form handling, WardFund uses server actions in Next.js 15. Here's an example:
