    ...
    initialMessages: [
      {
        id: 'welcome',
        role: 'assistant',
        content: 'Hi, here KindBot! I\'m your WardFund assistant. I can help you understand our project and answer any questions you have about WardFund. What would you like to know?'
      }
    ],
    body: {
  ...
  return (
    <div className="min-h-screen from-zinc-100">
      <div className="max-w-4xl mx-auto p-4 md:p-8">
        <div className="mb-8">
          <h1 className="text-3xl primary-foreground">WardFund Project Analysis</h1>
          <p className="text-primary-600">Ask me anything about WardFund's architecture, features, or implementation details.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="fixed bottom-0 left-0 right-0 p-4 border-t border-zinc-200 dark:border-zinc-700">
          <div className="max-w-4xl mx-auto flex gap-4">
            <input
              ...
              value={input}
              placeholder="Ask about WardFund..."
