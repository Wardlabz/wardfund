...
We recommend configuring Model Context Protocol (MCP) servers in your development environment to enhance your AI coding assistant's capabilities when working with WardFund. MCPs provide your AI assistant with direct access to documentation, APIs, and tools specific to our tech stack.
